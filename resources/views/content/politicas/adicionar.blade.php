@extends('layouts/contentNavbarLayout', ["container" => "container col-6"])
@section('title', 'Adicionar Política e Procedimento')
@section('content')

@include('_partials.styles.custom-container')
@include('_partials.titles.add-edit', ["title" => "Adicionar Política e Procedimento"])
